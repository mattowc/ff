...
if (isset($_GET['id'])) {
    ...
    if ($nc->is_action('save') || $nc->is_action('send')) {
        ...
        if (is_array($options_email_theme))
            $nc->data = array_merge($nc->data, $options_email_theme);
    }
        ...
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <br /><br />
                    max posts <?php $nc->text('_max_posts', 5); ?> 
                    <br /><br />
                    Categories to exclude:<br />
                    <?php
                        $categories = get_categories();
                        foreach($categories as $c)
                        {
            ...
            <tr valign="top">
                ...
                <td>
                    ...
                    <?php $nc->data['editor'] == 0?$nc->editor('message', 20):$nc->textarea_fixed('message', '100%'); ?>
                    <br />
