...
<div class="wrap">
<form method="post" action="admin.php?page=newsletter-pro/emails.php">
    <?php $nc->init(); ?>
<h2>Messages</h2> 

<p><a href="admin.php?page=newsletter-pro/emails-edit.php&amp;id=0" class="button">New message</a></p>
<p>
    ...
    <table class="widefat">
        ...
        <tbody>
            ...
            <tr>
                <td><a href="admin.php?page=newsletter-pro/emails-edit.php&amp;id=<?php echo $email->id; ?>"><?php echo $email->id; ?></a></td>
                <td><a href="admin.php?page=newsletter-pro/emails-edit.php&amp;id=<?php echo $email->id; ?>"><?php echo htmlspecialchars($email->subject); ?></a></td>
