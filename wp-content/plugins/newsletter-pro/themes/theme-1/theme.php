...
// wp-content/plugins/newsletter-custom/themes
...
// If you want to let Newsletter to prepare the post lists
$posts = $newsletter->theme_posts;

// Otherwise you can do it by hand

//$filters = array('showposts'=>$newsletter->theme_max_posts, 'post_status'=>'publish');
//if ($newsletter->theme_excluded_categories != '') $filter['cat'] = $newsletter->theme_excluded_categories;
