...
// Default values for follow up/autoresponder panel
$defaults_followup = array(
    'theme'=>'followp-1',
    'interval'=>48,
    'novisual' => 0,
    'enabled' => 0,
...
// Default configuration for feed by mail service
$defaults_feed = array(
    'enabled'=>0,
    'hour'=>6,
    'track'=>1,
    ...
    'add_new'=>0,
    'theme'=>'feed-1',
    'subject'=>  get_option('blogname') . ' weekly updates',
    'unsubscribed_text'=>'<p>Your subscription to the new posts notification of
        this blog has been removed (but you\'re still subscribed to our newsletter).'
);
